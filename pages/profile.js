              ...
              <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg bg-white">
                <div class="w-16 h-16 bg-gray-100 mr-4 flex justify-center items-center">
                  <img
                    ...
                    src="/material-icons/typescript-icon.svg"
                    width="64"
                    height="64"
                  />
                </div>
                <div class="flex-grow">
                  <h2 class="text-gray-900 title-font font-medium">TypeScript</h2>
              ...
              <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg bg-white">
                <div class="w-16 h-16 bg-gray-100 mr-4 flex justify-center items-center">
                  <img
                    alt="team"
                    class="w-16 object-cover object-center flex-shrink-0"
                    src="/material-icons/javascript.svg"
                    width="64"
                    height="64"
                  />
                </div>
              ...
              <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg bg-white">
                <div class="w-16 h-16 bg-gray-100 mr-4 flex justify-center items-center">
                  <img
                    alt="team"
                    class="w-16 object-cover object-center flex-shrink-0"
                    src="/material-icons/nextjs.svg"
                    width="64"
                    height="64"
                  />
                </div>
                <div class="flex-grow">
                  <h2 class="text-gray-900 title-font font-medium">Next.js</h2>
                </div>
              </div>
            </div>
            <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg bg-white">
                <div class="w-16 h-16 bg-gray-100 mr-4 flex justify-center items-center">
                  <img
                    alt="team"
                    class="w-16 object-cover object-center flex-shrink-0"
                    src="/material-icons/babel.svg"
                    width="64"
                    height="64"
                  />
                </div>
                <div class="flex-grow">
                  <h2 class="text-gray-900 title-font font-medium">Babel</h2>
                  <p class="text-gray-500"></p>
                </div>
              </div>
            </div>
              ...
              <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg bg-white">
                <div class="w-16 h-16 bg-gray-100 mr-4 flex justify-center items-center">
                  <img
                    alt="team"
                    class="w-16 object-cover object-center flex-shrink-0"
                    src="/material-icons/webpack.svg"
                    width="64"
                    height="64"
                  />
                </div>
                <div class="flex-grow">
                  <h2 class="text-gray-900 title-font font-medium">webpack</h2>
                  <p class="text-gray-500"></p>
                </div>
              </div>
            </div>
          ...
          <div class="flex flex-wrap w-full sm:mb-2 text-sm mt-8">
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Express</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">NestJS</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Gatsby</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Redux</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
            ...
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Vuex</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Apollo</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">GraphQL</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Puppeteer</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Jest</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Storybook</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Firebase</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Netlify</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
            ...
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Nginx</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">apatch</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
            ...
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">PostgreSQL</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Redis</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
            ...
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Flask</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
            ...
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Laravel</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Fuel PHP</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
            ...
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">VS Code</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Vim</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Zsh</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
            ...
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Figma</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
                ...
                <span class="title-font font-medium">Adobe XD</span>
              </div>
            </div>
            <div class="p-2 sm:w-1/4 w-1/2">
              <div class="flex h-full items-center">
